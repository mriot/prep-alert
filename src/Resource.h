...
#define RC_MAP_DATA                    1

// Generics
#define RC_GENERIC_ENHANCEMENT         2
#define RC_GENERIC_SIGIL               3
#define RC_GENERIC_FOOD                4

// Potion Buffs (Slaying)
#define RC_UNDEAD_SLAYING              5
#define RC_DEMON_SLAYING               6
#define RC_DREDGE_SLAYING              7
#define RC_FLAME_LEGION_SLAYING        8
#define RC_GHOST_SLAYING               9
#define RC_INQUEST_SLAYING            10
#define RC_NIGHTMARE_COURT_SLAYING    11
#define RC_OUTLAW_SLAYING             12
#define RC_DESTROYER_SLAYING          13
#define RC_ELEMENTAL_SLAYING          14
