...
namespace BuffIds
{
    ...
    constexpr int ELEMENTAL_SLAYING       = 9893;
    constexpr int DEMON_SLAYING           = 9901;
    constexpr int SONS_OF_SVANIR_SLAYING  = 9909;
    constexpr int INQUEST_SLAYING         = 9917;
    constexpr int FLAME_LEGION_SLAYING    = 9925;
    constexpr int OUTLAW_SLAYING          = 9933;
    ...
    constexpr int DEMON_SIGIL           = 9353;
    constexpr int DREDGE_SIGIL          = 9373;
    constexpr int GHOST_SIGIL           = 9701;
    constexpr int OUTLAW_SIGIL          = 9365;
    constexpr int NIGHTMARE_COURT_SIGIL = 9370;
    constexpr int INQUEST_SIGIL         = 9359;
    constexpr int DESTROYER_SIGIL       = 9343;
